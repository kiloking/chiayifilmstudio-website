...
function Section01() {
  ...
  const qaitems = [
    ...
    },
    {
      id: 3,
      q: "「入門班」和「進階班」的差別?",
      a: "入門班: 將著重從「0」開始學習，從攝影的鏡頭語言、數位知識、田野調查、劇本創作、實務拍攝、後製操作等，循序漸進地誕生屬於自己的第一個作品。<br/><br/> <div>進階班: 針對已具有基本故事內容與前、後期製作能力，課程強調在於如何讓作品更進一步被完善再到被看見、如何提案和行銷作品本身、及運用學習新興科技如VR(虛擬實境)或國際合製等。簡言之，只要您過去已經嘗試過拍攝並想更進一步完善作品，進階班較為合適。</div>",
    },
    {
      id: 4,
    ...
    },
    {
      id: 8,
      q: "擔心課程跟不上，怎麼辦?",
      a: "嘉義市影視音基地，會將每堂課程全程錄影，歡迎學員可以蒞臨基地複習觀看。<br/><br/><div>此外，每位學員都將搭配常態導師陪伴，並也有課程外的業師諮詢輔導的資源，再者，本基地亦提供基本攝影設備與剪輯軟體供學員免費優先使用。</div>",
    },
    {
      id: 9,
      q: "課程的教學形式為何?",
    ...
    <div className="bg-gradient-to-r from-[#152853] to-[#030409] ">
      ...
      <div className="w-10/12 md:w-7/12 mx-auto">
        ...
        <Typography variant="lead" color="white" className="my-10">
          ...
          透過導入影視音小班教學制，課程分成「入門班」和「進階班」，兼具系統性與實務性的課程設計，並藉由網羅全台各地具有實務經驗的業師蒞臨本市進行實體教學，力求每位學員都能與業師產生交集，並聯集琢磨新點子。{" "}
          <br /> <br />
