...
function Section01() {
  ...
  const qaitems=[
    ...
    {id:3,q:"「入門班」和「進階班」的差別?",a:"入門班:將著重從「0」開始學習，從攝影的鏡頭語言、數位知識、田野調查、劇本創作、實務拍攝、後製操作等，循序漸進地誕生屬於自己的第一個作品。<br/>進階班:針對已具有基本故事內容與前、後期製作能力，課程強調在於如何讓作品更進一步被完善再到被看見、如何提案和行銷作品本身、及運用學習新興科技如VR(虛擬實境)或國際合製等。簡言之，只要您過去已經嘗試過拍攝並想更進一步完善作品，進階班較為合適。"},
    {id:4,q:"入門班，真的完全沒有基礎也可以報名嗎?",a:"是的。我們熱烈歡迎只要對影視具有熱情的民眾報名。透過系列課程將帶領您從入門一步步學習到實作，基礎的理論知識必然存在，但課程設計將更著重於實務。人才培育計畫並不是一個培養會考試的補習班，而是一個期許能孵化出更多動人影視故事的場域。不用很厲害才可以開始，而是開始了才會變厲害!"},
    {id:5,q:"報名徵選有限制嗎，怎樣才能夠脫穎而出?",a:"只要符合報名資格即可。因此不論您是學生、社群小編、行銷企劃、影像工作者、演員、經營各行各業的店家想透過影像的方式增加曝光，或是活到老學到老的年長者等，只要對用影視說故事有熱情及想法，都歡迎報名!!<br/>本計畫徵選透過「報名表單」的各項問題進行審查，因此您的回答將是評審判斷的唯一依據，因此建議填寫完整，並盡可能完善加分項題目。"},
    ...
    {id:8,q:"擔心課程跟不上，怎麼辦?",a:"嘉義市影視音基地，會將每堂課程全程錄影，歡迎學員可以蒞臨基地複習觀看。此外，每位學員都將搭配常態導師陪伴，並也有課程外的業師諮詢輔導的資源，此外，本基地亦提供基本攝影設備與剪輯軟體供學員免費優先使用。"},
    {id:9,q:"課程的教學形式為何?",a:"課程將採活潑輕鬆的形式，影視人才培育計畫並沒有考試的壓力，期待講師與學員能雙向互動，共創出更多精彩故事。"},
    {id:10,q:"課程結束後，有什麼收穫?",a:"入門班學員，培養影視相關的知識及業界真正需要的能力，透過系統性的學習可以實際運用到學員當初報名時的目標;進階班學員，將在作品上加深美學基礎，除了影像技巧提升外，延伸接觸到行銷、募資等面向。如果你有夢想，你就能做到，別忘了就算視迪士尼的一切，都是由一個夢想和一隻老鼠所開始的。"},
  ]
  return (
    <div className='bg-gradient-to-r from-[#152853] to-[#030409] '>
      ...
      <div className='w-10/12 md:w-6/12 mx-auto'>
        ...
        【影視人才培育計畫】是片名，描述在影視世界尋找無盡可能的旅程! <br /> <br />
          ...
          對於想要透過影像說故事有興趣者，都非常歡迎您報名，一同釀造蠢蠢欲動的影視作
          品。
        </Typography>
        ...
        <Typography variant="lead" color='white' className='my-10 flex items-center gap-1'>詳見 <a href={process.env.PUBLIC_URL+'/images/課表日期與內容師資.pdf'} className='text-amber-400 hover:text-amber-200 flex items-center'> 【課表日期與師資】<FaFile /></a></Typography>
        ...
        <Typography variant="h3"  color="white" className='mt-16'>課程地點與交通方式</Typography>
        <Typography variant="lead" color='white' className='my-10'>嘉義市影視音基地 <br /> 地址:嘉義市西區北安路74-80號 (舊菸葉廠)</Typography>
        <div className='flex '>
          <div className='border-[#42cafe] border-4 w-1/2'>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3659.211886541369!2d120.43275259999999!3d23.488876400000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x346e9680873d3e6d%3A0xfa8a075a0d9b27b6!2zNjAw5ZiJ576p5biC6KW_5Y2A5YyX6IiI6KGXNDYw6Jmf!5e0!3m2!1szh-TW!2stw!4v1702391831500!5m2!1szh-TW!2stw" width="100%" height="100%"  allowFullscreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
          </div>
          <div className='w-1/2 '>
            <img src={process.env.PUBLIC_URL+'/images/S__42647560.jpg'} alt="" className='w-full object-cover h-full'/>
          </div>
        </div>
        <Typography variant="h5" color='white' className='my-10'>高鐵 |</Typography>
        <Typography variant="lead" color='white' className='my-10'>搭乘高鐵免費接駁車，至【自由友愛站】下車，並步行約5分鐘至嘉義市影視音基地</Typography>
        <Typography variant="h5" color='white' className='my-10'>火車 |</Typography>
        <Typography variant="lead" color='white' className='my-10'>嘉義市火車站-前站或嘉義火車站後站(嘉義市轉運中心)下車，搭乘公車綠色【中山幹線】至中興友愛路口下車，並步行約10分鐘至影視音基地</Typography>
        <Typography variant="h5" color='white' className='my-10'>公車 |</Typography>
        <Typography variant="lead" color='white' className='my-10'>搭乘綠線【中山幹線】至中興友愛路口站下車，並步行約15分鐘至嘉義市影視音基地</Typography>
        <Typography variant="lead" color='white' className='my-10'>搭乘菊線【光林我嘉線】至自由友忠路口站下車，並步行約20分鐘至嘉義市影視音基地</Typography>
