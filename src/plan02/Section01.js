  ...
  return (
    <div className='bg-gradient-to-r from-[#152853] to-[#030409] py-10'>
      <div className='w-10/12 md:w-6/12 mx-auto'>
        <Typography variant="h1"  className='text-center my-18 text-[#ffbe99]' id="p2">文字故事徵件計畫</Typography>
        <Typography variant="h3"  color="white" className='mt-16'>計畫主旨</Typography>
        <Typography variant="lead" color='white' className='my-10'>
          推廣與促進嘉義市行銷與發展城市魅力，以嘉義市為主要故事場景或故事內容，發掘更多在地的紀錄故事或產製微電影、劇情短片等，只需透過<span className='text-[#ffbe99]'>【1000字內】</span>的<span className='text-[#ffbe99]'>【文字故事】</span>內容進行投稿，故事內容必須至少含有30%嘉義市的元素，影片類型不限，舉凡:紀錄片、劇情片、動畫片、舞台藝術片、音樂歌舞片、VR短片等均可，但文字故事內容需要有實際轉製成為影片的可行性!  
        </Typography>
