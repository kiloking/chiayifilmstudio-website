...
function Section02() {
  ...
  return (
    <div className='taffic' id="p3">
      ...
      <Typography onClick={handleOpen} variant="lead" color='white'  className='my-5 flex items-center gap-2 cursor-pointer'> <FaTrainSubway /> 交通方式說明</Typography> 
